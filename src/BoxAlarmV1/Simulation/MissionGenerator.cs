...
public sealed class MissionGenerator
{
    ...
    public MissionGenerator(Random? random = null)
    {
    ...
    {
        var report = CallerReports[_random.Next(CallerReports.Length)];
        var building = BuildingTypes[_random.Next(BuildingTypes.Length)];
        ...
        var mission = new Mission
        {
            InitialCall = new CallInfo
            {
                ...
                AddressHint = $"Block {_random.Next(100, 999)}",
